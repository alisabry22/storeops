...
export function ApplySuccessDialog({ productLabel, regionsChanged, warnings = [], onClose }: Props) {
  useEffect(() => {
      ...
      <div className="relative z-10 w-full max-w-md mx-4 rounded-xl bg-zinc-900 border border-zinc-700 shadow-2xl p-6">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-base font-semibold text-white">Prices applied successfully</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <dl className="text-sm space-y-2 mb-4 rounded-md border border-zinc-800 bg-zinc-950/50 px-3 py-3">
          ...
          <div className="flex justify-between gap-3">
            <dt className="text-zinc-500">Regions updated</dt>
